   ...
   <?php
    ...
    public function create_action()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            if ($this->db->get_where('santri', array('no_santri'=>$this->input->post('no_santri')))->num_rows() <> 0) {
              ?>
              <script type="text/javascript">
    						alert('NO. SISWA "<?php echo $this->input->post('no_santri'); ?>" sudah ada !');
    						window.location="<?php echo base_url('santri/create'); ?>";
    					</script>
              <?php exit;
            }
