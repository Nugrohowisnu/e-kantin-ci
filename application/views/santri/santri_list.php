<div class="row" style="margin-bottom: 10px">
            <div class="col-md-4">
                <?php echo anchor(site_url('santri/create'),'Create', 'class="btn btn-primary"'); ?>
            </div>
            ...
            <div class="col-md-3 text-right">
                <form action="<?php echo site_url('santri/index'); ?>" class="form-inline" method="get">
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <a href="app/export_santri" target="_blank" class="btn btn-info">Export</a>
                <a href="app/hapus_semua_santri" onclick="javasciprt: return confirm('Apa kamu yakin ?')" class="btn btn-danger">Hapus Semua</a>
        </div>
...
<div id="myModal" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <!-- Modal content-->
    <form action="santri/upload" method="POST" enctype="multipart/form-data">
