<style>
	.sidebar ul.nav li a { color:#f1f1f1; }
</style>
<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar" style="background:#222;color:#f1f1f1;">
		...
		if ($this->session->userdata('level') == 'admin') { ?>
			...
			<li><a href="santri"><em class="fa fa-user">&nbsp;</em> Data Siswa</a></li>
			<li><a href="barang"><em class="fa fa-cube">&nbsp;</em> Data Barang</a></li>

			<li class="parent "><a data-toggle="collapse" href="#sub-item-2">
				<em class="fa fa-exchange">&nbsp;</em> Data Suplayer <span data-toggle="collapse" href="#sub-item-2" class="icon pull-right"><em class="fa fa-plus"></em></span>
				</a>
				<ul class="children collapse" id="sub-item-2">
					<li><a class="" href="suplayer">
						<span class="fa fa-arrow-right">&nbsp;</span> Data Suplayer
					</a></li>
